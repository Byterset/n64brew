...
\end{DoxyItemize}\hypertarget{index_autotoc_md23}{}\doxysection{todos}\label{index_autotoc_md23}
...
\hypertarget{index_autotoc_md25}{}\doxysubsection{install the n64 sdk}\label{index_autotoc_md25}
I am using the modern n64 homebrew sdk (crashsdk) and have based the build process around that.

mac\+OS/linux instructions\+: \href{https://crashoveride95.github.io/n64hbrew/modernsdk/startoff.html}{\texttt{ https\+://crashoveride95.\+github.\+io/n64hbrew/modernsdk/startoff.\+html}}\hypertarget{index_autotoc_md26}{}\doxysubsection{building the game}\label{index_autotoc_md26}
...
you can also create a file called {\ttfamily localdefs.\+makefile} containing any variables to override in the build, and it will be automatically included by the makefile.\hypertarget{index_autotoc_md27}{}\doxysection{dependencies}\label{index_autotoc_md27}

\begin{DoxyItemize}
\item lua (mesh export)
\item python (animation export, collision export, level export)
\end{DoxyItemize}\hypertarget{index_autotoc_md28}{}\doxysection{regenerate n64 header files for sprites}\label{index_autotoc_md28}
