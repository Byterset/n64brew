...
\item the build will also run the {\ttfamily generate\+\_\+sound\+\_\+ids.\+js} script which is used in the MAKEFILE to create a {\ttfamily \mbox{\hyperlink{clips_8h}{clips.\+h}}} header file. This header can be included in the code to reference the sound-\/clip you want to play. 
\end{DoxyItemize}